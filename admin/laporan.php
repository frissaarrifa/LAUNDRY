    ...
    ?>
        <div class="panel">
            ...
            <table class="table table-bordered table-striped">
                    ...
                    <?php
                        include '../koneksi.php';
                        $data = mysqli_query($koneksi, "SELECT * FROM pelanggan, transaksi WHERE pelanggan.pelanggan_id = transaksi.pelanggan_id AND DATE(transaksi_tanggal) >= '$dari'AND DATE(transaksi_tanggal) <= '$sampai'ORDER BY transaksi_id DESC");
                        $no = 1;
