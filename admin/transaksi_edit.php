			...
			?>
				<form method="POST" action="transaksi_update.php">
					...
					<div class="form-group">
						...
						<input type="date" name="tgl_selesai" class="form-control" placeholder="Masukkan berat cucian" required="required" value="<?php echo $t['transaksi_tgl_selesai'] ?>">
					</div>
					...
					<table class="table table-bordered table-striped">
						...
						?>
							<tr>
								...
								<td><input type="number" class="form-control" name="pakaian_jumblah[]" value="<?php echo $p['pakaian_jumblah']; ?>"></td>
							</tr>
						<?php
							}
						?>						
						<tr>
							...
							<td><input type="number" class="form-control" name="pakaian_jumblah[]"></td>
						</tr>
						<tr>
							<td><input type="text" class="form-control" name="pakaian_jenis[]"></td>
							<td><input type="number" class="form-control" name="pakaian_jumblah[]"></td>
